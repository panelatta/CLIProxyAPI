...
func (s *Server) setupRoutes() {
	...
	v1.Use(AuthMiddleware(s.accessManager), s.accessModelOverrideMiddleware())
	{
	...
	forceModelOverride := s.accessModelOverrideMiddleware()
	s.engine.GET("/v1/realtime", realtimeAuth, forceModelOverride, s.codexLiveHandler.HandleRealtimeWebsocket)
	s.engine.POST("/v1/realtime", realtimeAuth, forceModelOverride, s.codexLiveHandler.Handle)
	s.engine.POST("/v1/realtime/calls", realtimeAuth, forceModelOverride, s.codexLiveHandler.Handle)
	s.engine.GET("/v1/realtime/calls/:call_id", realtimeAuth, forceModelOverride, s.codexLiveHandler.HandleSideband)
	s.engine.POST("/v1/realtime/client_secrets", standardAuth, forceModelOverride, s.codexLiveHandler.CreateClientSecret)
	s.engine.POST("/v1/realtime/sessions", standardAuth, forceModelOverride, s.codexLiveHandler.CreateLegacySession)
	s.engine.POST("/v1/realtime/transcription_sessions", standardAuth, forceModelOverride, s.codexLiveHandler.HandleTranscriptionSession)
	s.engine.GET("/v1/realtime/translations", realtimeAuth, forceModelOverride, s.codexLiveHandler.HandleTranslation)
	s.engine.POST("/v1/realtime/translations", realtimeAuth, forceModelOverride, s.codexLiveHandler.HandleTranslation)
	s.engine.POST("/v1/realtime/translations/client_secrets", standardAuth, forceModelOverride, s.codexLiveHandler.HandleTranslation)
	s.engine.POST("/v1/realtime/calls/:call_id/hangup", standardAuth, forceModelOverride, s.codexLiveHandler.HandleHangup)
	s.engine.POST("/v1/realtime/calls/:call_id/accept", standardAuth, forceModelOverride, s.codexLiveHandler.HandleSIPControl)
	s.engine.POST("/v1/realtime/calls/:call_id/reject", standardAuth, forceModelOverride, s.codexLiveHandler.HandleSIPControl)
	s.engine.POST("/v1/realtime/calls/:call_id/refer", standardAuth, forceModelOverride, s.codexLiveHandler.HandleSIPControl)

	openaiV1 := s.engine.Group("/openai/v1")
	openaiV1.Use(AuthMiddleware(s.accessManager), s.accessModelOverrideMiddleware())
	{
	...
	codexDirect.Use(AuthMiddleware(s.accessManager), s.accessModelOverrideMiddleware())
	{
		codexDirect.GET("/responses", openaiResponsesHandlers.ResponsesWebsocket)
		codexDirect.GET("/responses/:response_id", openaiResponsesHandlers.GetResponse)
	...
	v1beta.Use(AuthMiddleware(s.accessManager), s.accessModelOverrideMiddleware())
	{
